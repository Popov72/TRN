TRN.extend(TRN.Play.prototype, {
	...
	meshSwap : function (obj1, obj2, meshIndex) {

		var geometry = obj1.geometry;
		var materials = obj1.material.materials;
		var attributes = materials[0].attributes;

		var geometrySrc = obj2.geometry;
		var materialsSrc = obj2.material.materials;
		var attributesSrc = materialsSrc[0].attributes;

		// remove the data from the obj1 and obj2
		var data1 = this.removeData(geometry, attributes, meshIndex);
		var data2 = this.removeData(geometrySrc, attributesSrc, meshIndex);

		// inject the data into obj1 and obj2
		this.addData(obj1, data2, materialsSrc);
		this.addData(obj2, data1, materials);
					...
					switch (action) {
						...
						case TRN.Animation.Commands.Misc.ANIMCMD_MISC_GETLEFTGUN: {
							...
							if (obj && lara) {
								...
								this.meshSwap(lara, obj, this.lara.leftHandIndex);
						...
						case TRN.Animation.Commands.Misc.ANIMCMD_MISC_GETRIGHTGUN: {
							...
							if (obj && lara) {
								...
								this.meshSwap(lara, obj, this.lara.rightHandIndex);
