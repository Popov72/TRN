...
TRN.Behaviours.BasicControl.prototype = {
    ...
    frameStarted : function(curTime, delta) {
        ...
        var q = new THREE.Quaternion();
        q.setFromAxisAngle( {x:0,y:1,z:0}, THREE.Math.degToRad(rotY) );
        this.object.quaternion = this.object.quaternion.multiplyQuaternions(q, this.object.quaternion);
        
        q = new THREE.Quaternion();
        q.setFromAxisAngle( (new THREE.Vector3(1,0,0)).applyQuaternion(this.object.quaternion), THREE.Math.degToRad(rotX) );
        this.object.quaternion = this.object.quaternion.multiplyQuaternions(q, this.object.quaternion);
        
        this.object.position.add(translate.applyQuaternion(this.object.quaternion));
    }
