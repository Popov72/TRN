TRN.gameFormatDescr.TR4 = {
	part1 : [
		...
		'', function(dataStream, struct) { TRN.Loader.unzip(dataStream, struct, struct.textile32_compSize); return ''; },
		'textile32', ['', ['', 'uint32', 256*256], function(struct, dataStream, type) 
		...
		'', function(dataStream, struct) { TRN.Loader.unzip(dataStream, struct, struct.textile32misc_compSize); return ''; },
		'textile32misc', ['', ['', 'uint32', 256*256], 2],
		'levelData_uncompSize', 'uint32',
		'levelData_compSize', 'uint32',
		'', function(dataStream, struct) { TRN.Loader.unzip(dataStream, struct, struct.levelData_compSize); return ''; },
		'unused', 'uint32',
		'numRooms', 'uint16',
		'rooms', ['', [ 
