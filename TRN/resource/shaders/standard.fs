...
const vec3 volFogCenter = vec3(52500.0, 3140.0, -49460.0);
const float volFogRadius = 6000.0;
//const vec3 volFogCenter = vec3(36220.0, 5170.0, -45540.0);
//const float volFogRadius = 4000.0;
const vec3 volFogColor = vec3(0.1, 0.75, 0.3);

const float volFogRadius2 = volFogRadius * volFogRadius;
